...
public class Hanwhatribes2 {
	...
	public static void hanwhatribes() throws MalformedURLException, InterruptedException  {
		...
		public static void tribeslist() throws MalformedURLException, InterruptedException  {
			...
			WebElement toastView = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.widget.TextView"));
			String text = toastView.getAttribute("입장후, 다양한 혜택 정보에 접근이 가능해요!");
			System.out.println("토스트 팝업 확인"); 	
			
			
			
			WebDriverWait wait = new WebDriverWait(driver,20);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("arrow beside text in button")));
			System.out.println("id 찾으면 넘어가보자"); 	
